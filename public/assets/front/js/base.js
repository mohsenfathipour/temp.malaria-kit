...
function darkModeSets(){
    document.querySelectorAll('.toman-img').forEach(function(imgElement) {
            imgElement.src = '/assets/img/toman_white.svg';
    });
}
function darkModeUnSets(){
    document.querySelectorAll('.toman-img').forEach(function(imgElement) {
            imgElement.src = '/assets/img/toman.svg';
    });
}
